...
from 無限 mugen import CarParkTool

__CHANNEL_USERNAME__ = "MUGEN"
__GROUP_USERNAME__   = "MUGEN"
...
def banner(console):
    ...
    brand_name = figlet_format('MUGEN', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄  ')) 
    print(Colorate.Horizontal(Colors.rainbow, f' ‌           fb: @{__CHANNEL_USERNAME__} 𝐎𝐫 @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.rainbow, '=================================================================='))
